...
var dataf3=[{
    ...
    title: '美的韩美格2017春秋新款修身大码蕾丝网纱打底衫女长袖薄款圆领女T恤 全店商品 二件减5元 三件减10',
    pricelow: '¥158.00',
    describe:'蕾丝网纱打底衫',
    id:49,
    price: '¥158.00',
    ...
    title: '乐力初棉纯色圆领长袖T恤打底衫秋衣女上衣体恤女士修身打底衣春秋 挺拔有型 棉氨材质 柔软舒适 耐洗耐磨',
    pricelow: '¥88.00',
    describe:'女士修身打底衣',
    id:51,
    price: '¥88.00',
    ...
    title: 'LG17年春夏新款百搭半身裙蛋糕裙 a字裙 裤裙伞裙大码裙子超短裙女 松紧腰围 带裤边打底衬 涤针织面料',
    pricelow: '¥118.00',
    describe:'裤裙伞裙',
    id:53,
    price: '¥118.00',
    ...
    title: '金利来森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流',
    pricelow: '¥399.00',
    describe:'金利来森马夹克',
    id:61,
    price: '¥399.00',
    ...
    title: '康恩贝裤子男士哈伦裤春季新款2017束脚裤修身韩版潮流小脚裤男裤休闲裤 弹力',
    pricelow: '¥15.00',
    describe:'康恩贝裤子',
    id:62,
    price: '¥15.00',
...
function laoddataf1(fatherbox) {
    $(fatherbox).each(function(index,value){
        ...
        $(value).children('.a-f')[0].href+='?id:'+dataf1[index].id;
    })
}
function laoddataf2(fatherbox) {
    $(fatherbox).each(function(index, value) {
        $(value).find('.goods-list-img-z').children('a')[0].href='loupe.html?id:'+dataf2[index].id;
        $(value).find('.goods-list-img-z').find('img').each(function(inde, valu) {
            var obj = dataf2[index].children[0];
            for (var key in obj) {
                $(valu).attr('src', obj[key]);
            };
        });
        $(value).children('div').children('div').eq(0).html(dataf2[index].pricelow);
        $(value).find('b').text(dataf2[index].introduce);
    ...
    var index = 0;
    for (var i = 0; i < dataf2.length; i++) {
        for (var j = 0; j < dataf2[i].children.length; j++) {
            obj[index] = dataf2[i].children[j].smallPic;
...
function laoddataf3(fatherbox){
    $(fatherbox).each(function(index,value){
        ...
        $(value).children('.a-f')[0].href+='?id:'+dataf3[index].id;
